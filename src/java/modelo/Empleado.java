...
@NamedQueries({
    ...
    @NamedQuery(name = "Empleado.findByIdDep", query = "SELECT e FROM Empleado e WHERE e.idDep = :idDep")})
public class Empleado implements Serializable {
    ...
    @Column(name = "id_dep")
    private int idDep;
    @JoinColumn(name = "id_emp", referencedColumnName = "id_dep", insertable = false, updatable = false)
    ...
    public Empleado(Integer idEmp, String nombre, int idDep) {
        this.idEmp = idEmp;
        this.nombre = nombre;
        this.idDep = idDep;
    }
